...
<details>
<summary><b>[134] Spartan[wght].ttf</b></summary>
<details>
...
* ℹ **INFO** Could not detect which version of ttfautohint was used in this font. It is typically specified as a comment in the font version entries of the 'name' table. Such font version strings are currently: ['Version 1.003'] [code: version-not-detected]
...
* ℹ **INFO** Version string is: "Version 1.003"
...
* ℹ **INFO** This font contains the following optional tables [prep, DSIG, loca, gasp, GPOS, GSUB]
...
* 🍞 **PASS** Spartan[wght].ttf is named canonically.
